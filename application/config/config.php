...
|
*/
$config['base_url'] = (isset($_SERVER['HTTP_HOST'])) ? ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on') ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . str_replace(basename($_SERVER['SCRIPT_NAME']), '', $_SERVER['SCRIPT_NAME']) : 'http://localhost/www.peduli-mahasiswa.com/';
...
|
*/
$config['encryption_key'] = 'peduli_mahasiswa_key_2026';
